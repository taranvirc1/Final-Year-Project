...
function MapSection() {
  return (
    <div className="map-container">
      <h2 className="map-title">Where it all started</h2>
      {/* Iframe is used to display the map on the screen which specified dimensions */}
      {/* Src: Location of map to be displayed */}
      <iframe
        title="mymap"
