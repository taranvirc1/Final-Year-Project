...
public class SecurityConfiguration {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http
            ...
            .antMatchers( "/user", "/donators", "/payments", "/forgot_password","/getReviews/{courseID}","/categories/{courseID}","/threads", "/threadName/{threadName}", "/messages/{threadId}", "/threadid/{threadId}")
            .permitAll()
            .and()
            .authorizeRequests()
